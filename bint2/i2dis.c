...
Forward Hidden Procedure d_char(char c, displadm *da);
...
Forward Hidden Procedure d_newline(displadm *da);
Forward Hidden Procedure d_special(parsetree v, string *t, displadm *da);
Forward Hidden Procedure d_string(string s, displadm *da);
...
Forward Hidden Procedure indentv(value v, displadm *da);
Forward Hidden bool no_space_before_comment(value v);
Forward Hidden Procedure set_ilevel(displadm *da);
...
Hidden Procedure indentv(value v, displadm *da) {
	if (Doneline(da)) {
		Dstop(da) = Yes;
		return;
	}
