#ifndef ABC_BHDRS_B_HEADER
#define ABC_BHDRS_B_HEADER
 ...
 * By casting to intptr_t and shifting one bit to the right, it is converted
...
#define SmallIntVal(v) ((int)(((intptr_t)(v) & ~1) / 2))
	/* Casting v to intptr_t to not lose information. Then, since we know
		SmallIntVals will not be larger than an int, casting the result to int is safe*/
