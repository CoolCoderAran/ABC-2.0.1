#ifndef ABC_IHDRS_I2PAR_HEADER
#define ABC_IHDRS_I2PAR_HEADER
...
parsetree cmd_suite(intlet cil, bool first, parsetree (*suite)(intlet, bool, bool*));
parsetree cmd_seq(intlet cil, bool first, bool *em);
parsetree ucmd_seq(intlet cil, bool first, bool *em);
value tail_line(void);

/* B units */

parsetree unit(bool heading, bool editing);
parsetree collateral(txptr q, parsetree (*base)(txptr));
parsetree compound(txptr q, parsetree (*base)(txptr));
