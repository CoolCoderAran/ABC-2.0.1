...
Forward Hidden Procedure dowri_vals(value l, value u);
Forward Hidden Procedure end_read();
Forward Hidden bool fileline(FILE *fp, bufadm *bp);
Forward Hidden Procedure init_read();
Forward Hidden Procedure initoutbuf();
Forward Hidden int intsize(value v);
Forward Hidden Procedure push_ch(char c);
Forward Hidden Procedure put_ch(char c);
Forward Hidden Procedure q_mess(int m, char c1, char c2);
Forward Hidden char *read_line(literal kind, bool should_prompt, bool *eof);
Forward Hidden Procedure writoutbuf();
