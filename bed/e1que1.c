...
Visible Procedure
addstringtoqueue(queue *pq, string str) {
...
Visible Procedure
nosuggtoqueue(environment *ep, queue *pq) {
	queue q = Qnil;
	register int i;
	register string *rp;
	register node n;
...
Visible Procedure
fixfocus(environment *ep, int len) {
	node nn;
