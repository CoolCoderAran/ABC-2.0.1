...
Forward Hidden bool dosense(environment *ep, string sense, string format);
Forward Hidden Procedure fixsublist(environment *ep);
Forward Hidden bool gotoscrollbar(environment *ep, int x);
...
Hidden bool dosense(environment *ep, string sense, string format) {
	int y;
	int x;
...
Hidden bool gotoscrollbar(environment *ep, int x) {
	int w;
...
Visible bool gotoyx(environment *ep, int y, int x) {
	register node n;
	register string *rp;
	register int i;
	register int pc;
...
Hidden int poscomp(path p, int y, int x) {
	register int ly;
	register int lx;
	register int w;
	register string *rp;
...
Hidden Procedure fixsublist(environment *ep) {
