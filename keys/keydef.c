...
Forward Hidden bool a_harddef(tabent *d);
Forward Hidden string ask_name(string prompt);
Forward Hidden string ask_representation(string dfltrep);
Forward Hidden string ask_to_click(int y, int x, string prompt, int *plen);
Forward Hidden Procedure asktocontinue();
Forward Hidden int asktodelete(tabent *d);
Forward Hidden Procedure checkwinsize(int width, int height);
Forward Hidden Procedure chr2fmt(char ch);
Forward Hidden Procedure clearscreen();
Forward Hidden Procedure clearwindow();
Forward Hidden Procedure closekeyfile();
Forward Hidden Procedure definemouse();
Forward Hidden bool defmouse();
Forward Hidden Procedure delentry(tabent *d);
Forward Hidden Procedure delhelp();
Forward Hidden Procedure delprompt(string rep, string name, int *y, int *x);
Forward Hidden Procedure endfmt();
Forward Hidden Procedure endprocess(int status);
Forward Hidden bool equal(int l1, string s1, int l2, string s2);
Forward Hidden bool equdef(int len1, string def1, int len2, string def2);
Forward Hidden string findoldrepr(int deflen, string def);
Forward Hidden string findrepr(int len, string def);
Forward Hidden tabent *findsavedhardstringentry(int code);
Forward Hidden tabent *findstringentry(int code);
Forward Hidden Procedure fini();
Forward Hidden Procedure fini_buffers();
Forward Hidden Procedure fini_term();
Forward Hidden string getbuf(bufadm *bp);
Forward Hidden string getinput(bufadm *bp);
Forward Hidden Procedure getstartposition(bool xzero, int *y, int *x);
Forward Hidden bool illegal(string def, int deflen);
...
Forward Hidden int inkey(int *pc);
Forward Hidden bool is_init(string name);
Forward Hidden bool is_quit(string name);
Forward Hidden Procedure keep(int code, string name, int deflen, string def, string rep);
Forward Hidden Procedure khelp();
Forward Hidden Procedure knextline();
Forward Hidden bool knownkeysequence(int *pnkey, string *key, string *rep);
Forward Hidden Procedure longhelp();
Forward Hidden string makereprofdef(int deflen, string def);
Forward Hidden string mkstandout(string data);
Forward Hidden bool morehelp();
Forward Hidden string new_representation(string dfltrep, int deflen, string def);
Forward Hidden Procedure nomouse();
Forward Hidden Procedure openkeyfile();
Forward Hidden Procedure outstring(string str);
Forward Hidden Procedure prcnt2toprcnt3();
Forward Hidden Procedure print_heading();
Forward Hidden Procedure put_def(string name, int deflen, string def, string rep);
Forward Hidden Procedure put_strings();
Forward Hidden Procedure put_table();
Forward Hidden Procedure putkeydefs();
Forward Hidden Procedure redrawscreen();
Forward Hidden bool rep_in_use(string rep, int deflen, string def);
Forward Hidden string savedef(string def, int len);
Forward Hidden Procedure savputrepr(bufadm *rp, string repr);
Forward Hidden Procedure scrolloffheading();
Forward Hidden Procedure sendendstring();
Forward Hidden Procedure sendinistring();
Forward Hidden Procedure set_windows(int yfirst);
Forward Hidden Procedure shorthelp();
Forward Hidden Procedure startfmt(int syz);
Forward Hidden Procedure store(int code, string name, int deflen, string def, string rep);
Forward Hidden Procedure str2fmt(string s);
Forward Hidden bool toformat(char **pp, char **ppf, char **ppo, bool diflen);
Forward Hidden bool unlawful(string rep);
Forward Hidden Procedure usage();
Forward Hidden Procedure putdata(string data, bool xzero);
...
#define Printable(c)	(chr_isascii(c) && (isprint(c) || (c) == ' '))
...
// WE DO THE _POSIX_SOURCE hack for fileno
...
Hidden Procedure setstartposition(bool xzero)
...
Hidden Procedure putdata(string data, bool xzero) {
...
Hidden Procedure message(
		string data, bool xzero /* if Yes, start in first line position */
) {
	char *buf, *pbuf;
	int lendata, len;
	char *p, *q;
...
Hidden Procedure asktocontinue() {
	...
	trmputdata(y, y, 0, data, mkstandout(data));
		/*
		 * putdata() isn't called to avoid a call of knextline();
...
Forward Hidden Procedure showbindings(operation *op);
Forward Hidden Procedure delbindings(operation *op);
Forward Hidden Procedure definebinding(operation *op);
...
Hidden Procedure delprompt(string rep, string name, int *y, int *x) {
	...
	if (strlen(rep) > (unsigned)win.width)
		outofsync = Yes;
	*y = win.y;
	*x = win.x;
}
...
Hidden bool toformat(char **pp, char **ppf, char **ppo, bool diflen) {
