#ifndef ABC_UNIX_OS_HEADER
#define ABC_UNIX_OS_HEADER
...
#include <ncurses/termcap.h>    /* terminal capabilities see termcap, curses, or ncurses */
...
/* is this a termios/termio/sgtty system (unix) */
#define TERMIOS
#undef  TERMIO
#undef  SGTTY
