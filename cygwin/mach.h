...
/* maxlong=9223372036854775807 (=2**63-1) */
/* pointers=64 bits BEWARE! larger than int! */
/* base=2 */
...
#define ABCBASE 1000000000
#define tenlogBASE 9 /*  = log10(ABCBASE) */
...
#define LONGBITS 53 /* The number of bits in a long */
#define TWOTO_DBLBITSMIN1 4503599627370496.0 /* 2**(DBLBITS-1) */
#define TWOTO_LONGBITS 9007199254740992.0 /* 2**LONGBITS */
...
#define HEADER literal type; reftype refcnt; intlet len; char filler[2]
#define FILLER {0, 0},
