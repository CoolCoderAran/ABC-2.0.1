...
Hidden value uplower(value t, int (*islowupper)(int), int (*touplower)(int)) {
	value i, sizt, r, ti, c;
	char s[2];
...
#ifdef isupper
int F_isupper(int c) { return isupper(c); }
#else
#define F_isupper isupper
// extern int isupper();
#endif
#ifdef islower
int F_islower(int c) { return islower(c); }
#else
#define F_islower islower
// extern int islower();
#endif
#ifdef toupper
int F_toupper(int c) { return toupper(c); }
#else
#define F_toupper toupper
// extern int toupper();
#endif
#ifdef tolower
int F_tolower(int c) { return tolower(c); }
#else
