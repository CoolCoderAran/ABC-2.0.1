...
Forward Hidden bool nextchar(environment *ep, int direction);
Forward Hidden bool prevnext(environment *ep, int direction);
Forward Hidden bool tabstop(environment *ep, int i);
Forward Hidden bool updownarrow(environment *ep, int yincr);

/*
 * Common code for PREVIOUS and NEXT commands.
 */

Hidden bool prevnext(environment *ep, int direction) {
	node n;
	node n1;
	int nch;
	int i;
...
Hidden bool nextchar(environment *ep, int direction) {
	register int ich;
	register int nch;
	register node n;
	node n1;
...
Hidden bool updownarrow(environment *ep, int yincr) {
	int y, x;
...
Visible bool upline(environment *ep) {
	register int y;
...
Visible bool downline(environment *ep) {
	register int w;
...
Hidden bool tabstop(environment *ep, int i) {
