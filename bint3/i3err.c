...
Forward Hidden Procedure message(int m1, int m2, bool in_node, bool at, value arg);
Forward Hidden Procedure nline();
Forward Hidden Procedure pr_line(bool at);
...
Forward Hidden Procedure show_where(bool in_node, bool at, parsetree node);
Forward Hidden bool unit_file();
Forward Hidden value unitname(int line_no);
