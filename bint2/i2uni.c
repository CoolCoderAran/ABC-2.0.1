...
Forward Hidden parsetree n_collateral(txptr q, intlet n, parsetree (*base)(txptr));
Forward Hidden parsetree  ref_suite(intlet cil);
Forward Hidden bool share(txptr q, parsetree *v, value *c);
Forward Hidden parsetree singidf(txptr q);
Forward Hidden Procedure treat_idf(value t);
...
Hidden parsetree n_collateral(txptr q, intlet n, parsetree (*base)(txptr)) {
...
Visible parsetree collateral(txptr q, parsetree (*base)(txptr)) {
	return n_collateral(q, 1, base);
}

Visible parsetree compound(txptr q, parsetree (*base)(txptr)) {
