...
Forward Hidden bool keymark(txptr ty);
Forward Hidden bool la_denum(txptr tx0);
Forward Hidden txptr lcol(void);
Forward Hidden bool relsearch(string s, txptr q, txptr *ftx);
Forward Hidden bool search(bool find_kw, string s, txptr q, txptr *ftx, txptr *ttx);
Forward Hidden bool spec_firstkeyword(char *fkw);
Forward Hidden value tag(void);
