...
Forward Hidden Procedure del_perm(value pname);
...
Forward Hidden Procedure free_unit(value pname);
Forward Hidden Procedure freeunits(literal which);
Forward Hidden Procedure get_heading(parsetree *h, value *pname);
Forward Hidden value get_tfname(value name);
Forward Hidden value get_ufname(value pname, bool silently);
Forward Hidden bool isfunction(value name, literal *type, wsenvptr *wse);
Forward Hidden bool islocation(value name, literal *type, wsenvptr *wse);
Forward Hidden bool ispredicate(value name, literal *type, wsenvptr *wse);
Forward Hidden bool isunitentry(value pname);
Forward Hidden Procedure lst_fileheading(value v);
Forward Hidden bool name_clash_after_editing(value pname);
Forward Hidden bool name_conflict_while_creating(value pname);
...
Forward Hidden Procedure tarfiled(value name, value v);
Forward Hidden Procedure u_name_type(parsetree v, value *name, literal *type);
...
#ifdef TYPE_CHECK
Forward Visible value stc_code(value pname);
#endif
