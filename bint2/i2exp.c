...
Forward Hidden bool elt_dis(parsetree *v);
Forward Hidden Procedure initstack(expadm *adm, int n);
Forward Hidden bool is_conversion(txptr q, parsetree *v);
Forward Hidden Procedure list_dis(txptr q, parsetree *v);
Forward Hidden Procedure list_item(txptr q, expadm *adm);
Forward Hidden parsetree par_expr(txptr q, expadm *adm);
Forward Hidden parsetree par_lta(txptr q, expadm *adm, Procedure (*lta_item)(txptr, expadm*));
Forward Hidden Procedure push_dya(expadm *adm, value v);
Forward Hidden bool range_elem(txptr q, parsetree *v);
Forward Hidden bool sel_tag(txptr q, parsetree *v);
Forward Hidden Procedure st_extend(expadm *adm);
Forward Hidden bool tab_dis(txptr q, parsetree *v);
Forward Hidden Procedure tab_item(txptr q, expadm *adm);
...
Hidden parsetree par_lta(txptr q, expadm *adm, Procedure (*lta_item)(txptr, expadm*)) {
	txptr ftx, ttx;
	int n;
	parsetree v;
