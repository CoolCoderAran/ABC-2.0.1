...
typedef value (*valfun)(integer u, integer v);
typedef rational (*ratfun)(rational u, rational v);
typedef real (*appfun)(real u, real v);
typedef double (*mathfun)(double x);
...
Visible value sum(value u, value v) {
	...
	return dyop(u, v, (valfun)int_sum, rat_sum, app_sum);
}
...
Visible value diff(value u, value v) {
	if (IsSmallInt(u) && IsSmallInt(v))
		return (value) mk_int(
			(double)SmallIntVal(u) - (double)SmallIntVal(v));
	return dyop(u, v, (valfun)int_diff, rat_diff, app_diff);
}
...
Visible value prod(value u, value v) {
	if (IsSmallInt(u) && IsSmallInt(v))
		return (value) mk_int(
			(double)SmallIntVal(u) * (double)SmallIntVal(v));
	return dyop(u, v, (valfun)int_prod, rat_prod, app_prod);
}
...
Visible value mod(value u, value v) {
	value q, f, d, p;
...
Visible value power(value u, value v) {
	real ru, rv, rw;
...
Visible value log2(value u, value v) {
	value w;
	if (numcomp(u, zero) <= 0) {
